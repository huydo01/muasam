          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=company&act=save1<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">
                ...
                <div class="col-md-10"><input type="text" name="title_vi" id="title" value="<?=$item['title_vi']?>" placeholder="Tiêu đề bản đồ" /></div>
				<!--
				<div class="col-md-2"><label>Tiêu đề bản đồ (en)</label></div>
                <div class="col-md-10"><input type="text" name="title_en" id="title" value="<?=$item['title_en']?>" placeholder="Tiêu đề bản đồ" /></div>
				-->
				
                <div class="col-md-2"><label>Tên công ty </label></div>
                <div class="col-md-10"><input type="text" name="ten_vi" id="ten" value="<?=$item['ten_vi']?>" placeholder="Tên công ty" /></div>
				<!--
				<div class="col-md-2"><label>Tên công ty (en)</label></div>
                <div class="col-md-10"><input type="text" name="ten_en" id="ten" value="<?=$item['ten_en']?>" placeholder="Tên công ty" /></div>
				-->
				
                <div class="col-md-2"><label>Địa chỉ </label></div>
                <div class="col-md-10"><input type="text" name="diachi_vi" id="diachi" value="<?=$item['diachi_vi']?>" placeholder="Địa chỉ" /></div>
				<!--
				<div class="col-md-2"><label>Địa chỉ (en)</label></div>
                <div class="col-md-10"><input type="text" name="diachi_en" id="diachi" value="<?=$item['diachi_en']?>" placeholder="Địa chỉ" /></div>
                ...
                <div class="col-md-10"><input type="text" name="website" id="website" value="<?=$item['website']?>" placeholder="Ví dụ: 10.834718,106.622268" /></div>
