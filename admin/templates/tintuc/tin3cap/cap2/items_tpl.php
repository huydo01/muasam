          ...
          <div class="inner">
            ...
            <div class="title-bar">
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4><a href="index.php?com=tin3cap&act=add_cat1<?=$chuoi_noi_curpage2?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm danh mục cấp 2</a></h4>      
              </div>
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">           
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=tin3cap&act=edit_cat1&id=<?=$v['id']?><?=$chuoi_noi_curpage2?>" style="text-decoration:none;"><?=$v['ten_vi']?></a></td>
