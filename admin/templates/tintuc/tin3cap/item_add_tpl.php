          ...
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=tin3cap&act=save<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">
                ...
                <div class="col-md-10"><img src="<?=_upload_tin3cap.$item['photo']?>"  width="213" alt="NO PHOTO" /><br /><br /></div>
                <?php }?>
                <div class="col-md-2"><label>Hình ảnh</label></div>
                <div class="col-md-10">
                	<input type="file" name="file" /> 
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: 213x100 (theo px)</span>
                    <br /><br />
                </div>
               ...
               -->
                ...
                <div class="col-md-10"><textarea name="noidung_en" id="noidung_en" cols="50" rows="6"><?=$item['noidung_en']?></textarea><br /></div> 
                 <div class="col-md-2"><label>Link Youtube</label></div>
                <div class="col-md-10"><input type="text" name="youtube" value="<?=$item['youtube']?>" placeholder="Ví dụ: YNoIa35sY48" />
                	<span class="description">Ví dụ: https://www.youtube.com/watch?v=<b style="color:#F00;">YNoIa35sY48</b> ==> Chỉ lấy đoạn màu đỏ</span>
                    <br /><br />
                </div>


				<div class="col-md-2"><label>Link Google map</label></div>
                <div class="col-md-10"><input type="text" name="googlemap" value="<?=$item['googlemap']?>" placeholder="Ví dụ: https://www.google.com/maps/place/485+C%E1%BB%99ng+H%C3%B2a,+ph%C6%B0%E1%BB%9Dng+13,+T%C3%A2n+B%C3%ACnh,+H%E1%BB%93+Ch%C3%AD+Minh,+Vi%E1%BB%87t+Nam/@10.8024726,106.6391002,17z/data=!3m1!4b1!4m2!3m1!1s0x3175294fe48cfb2f:0xf6cd38c4e62db8fc" />
