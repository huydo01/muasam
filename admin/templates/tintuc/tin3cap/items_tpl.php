  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tin3cap&act=man">Hoàn thiện</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
            ...
            <div class="title-bar">
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4> <a href="index.php?com=tin3cap&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Hoàn thiện</a></h4>      
              </div>
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">   
                ...
                <tbody>
                 ...
                 <!--
                    ...
                    <td style="width:76px;"><a href="index.php?com=tin3cap&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=_upload_tin3cap.$v['photo']?>" border="1" class="sp_img" /></a></td> 
                                     
                    <td><a href="index.php?com=tin3cap&act=edit&id=<?=$v['id']?><?=$chuoi_noi_curpage?>"><?=$v['ten_vi']?></a></td> 
                   
                  <!--  <td style="width:5%;"><a href="index.php?com=tin3cap&act=man&noibat=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> -->
                  <!--   <td style="width:5%;"><a href="index.php?com=tin3cap&act=man&tinmoi=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['tinmoi']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>
                    --> 
               <td style="width:5%;"><a href="index.php?com=tin3cap&act=man_photo&id_cat=<?=$v['id']?><?=$chuoi_noi_curpage?>">Thêm</a></td>
                    <td style="width:5%;"><a href="index.php?com=tin3cap&act=man&hienthi=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-6 paging_right_10px">                  
                  <a href="index.php?com=tin3cap&act=add<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Hoàn thiện</a>
