...
<!--              
              <?php if ($_REQUEST['act']=='edit3'){?>
                ...
                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['photo']?>"  width="112" alt="NO PHOTO" /><br /><br /></div>
                <?php }?>
                <div class="col-md-2"><label>Hình ảnh</label></div>
                <div class="col-md-10">
                	<input type="file" name="file" /> 
                    <span class="description">Type: .jpg|.gif|.png|.jpeg &nbsp;&nbsp;;&nbsp;&nbsp; Ảnh chuẩn: Width:112px - Height: 72px</span>
                    <br /><br />
                </div>
                -->
