		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=tinnho&act=save4<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">              
                <?php if ($_REQUEST['act']=='edit4'){?>
                <div class="col-md-2"><label>Hình hiện tại</label></div>
                <div class="col-md-10"><img src="<?=_upload_tinnho.$item['photo']?>"  width="90%" alt="NO PHOTO" /><br /><br /></div>
                <?php }?>
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Type: .pdf|.doc|.docx|xlsx &nbsp;&nbsp;;&nbsp;&nbsp;</span>
                    <br /><br />
                </div>
