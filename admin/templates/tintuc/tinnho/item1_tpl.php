...
<!-- Breadcrumbs Start -->
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man1">Sau khi sử dụng</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="message-box info">
             ...
             <!-- <p>Lưu ý: Nổi bật là tin sẽ hiển thị khi click vào Sau khi sử dụng trên MENU TOP!</p>-->
            </div>
        </div>
        ...
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="inner">
            ...
            <div class="table-holder">
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
                ...
                <tbody>
                 ...
                 <td style="width:5%;"><a href="index.php?com=tinnho&act=man1&noibat=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>
                    <!--<td style="width:5%;"><a href="index.php?com=tinnho&act=man1&tinmoi=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['tinmoi']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>-->
                    <td style="width:5%;"><a href="index.php?com=tinnho&act=man1&hienthi=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                  <a href="index.php?com=tinnho&act=add1<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm tin tức 1</a>
