  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=tinnho&act=man3">Tuyển dụng</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
            ...
            <div class="title-bar"> 
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<!--<h4><a href="index.php?com=tinnho&act=add3<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Tuyển dụng</a></h4>      -->
              </div>
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">            
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=tinnho&act=edit3&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten_vi']?></a></td>
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                 <!--<a href="index.php?com=tinnho&act=add3<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm Tuyển dụng</a>-->
