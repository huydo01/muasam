            ...
            <div class="inner">
              ...
              <?php
				function get_main_category($a)
					...
					{
						$sql="select * from table_congtrinh_cat where com='cat1' and id_cat=$a order by stt asc,id desc";
						$stmt=mysql_query($sql);
						$str='
              ...
              <form method="post" name="frm" action="index.php?com=congtrinh&act=save_cat2<?=$chuoi_noi_curpage3?>" enctype="multipart/form-data" class="basic-form inline-form">
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=congtrinh&act=man_cat2<?=$chuoi_noi_curpage3?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
