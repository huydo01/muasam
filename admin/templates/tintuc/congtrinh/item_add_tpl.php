	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="inner">
              ...
              <?php
				function get_main_category($a)
					...
					{
						$sql="select * from table_congtrinh_cat where com='cat2' and id_cat1=$a order by stt asc,id desc";
						$stmt=mysql_query($sql);
						$str='
				...
				?>               
              <form method="post" name="frm" action="index.php?com=congtrinh&act=save<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">
       ...
       -->
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Type: .pdf|.png|.jpeg|.doc|.docx|.rar|.zip|.pr</span>
                    <br /><br />
                </div>
