            ...
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=photo&act=save_banner" enctype="multipart/form-data" class="basic-form inline-form">                              
                ...
                <div class="col-md-10">
                    ...
                    <object width="290px" height="275px"  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
                      ...
                      <embed src="<?=_upload_hinhanh.$item['photo']?>" quality="High" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="290px" height="275px" scale="ExactFit"></embed>
                    </object>            
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Width:290px&nbsp;-&nbsp;Height:275px&nbsp;Type:&nbsp;.swf | .jpeg | .gif | .png | .gif</span>
                    <br /><br />
                </div>
                ...
                <div class="col-md-10">
                    ...
                    <img src="<?=_upload_hinhanh.$item['thumb']?>" width="290px" height="275px" border="0" />             
                ...
                <div class="col-md-10">
                    ...
                    <span class="description">Width:290px&nbsp;-&nbsp;Height:275px&nbsp;Type:&nbsp; .jpeg | .gif | .png | .gif</span>
                    <br /><br />
                </div>
