  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=man_quangcao2ben1<?=$chuoi_noi_curpage?>">Quảng cáo 2 bên RIGHT</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">         
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=photo&act=edit_quangcao2ben1&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_hinhanh.$v['photo']?>" width="150" border="0" /></a></td>
                    ...
                    <td style="width:5%;"><a href="index.php?com=photo&act=man_quangcao2ben1&hienthi=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
