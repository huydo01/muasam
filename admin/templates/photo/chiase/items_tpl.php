  ...
  <div class="row breadcrumbs">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <ul class="breadcrumbs">
        ...
        <li><a href="index.php?com=photo&act=man_chiase">Link</a></li>
      </ul>
    </div>
  </div>
  <!-- Breadcrumbs End -->
          ...
          <div class="inner">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <!-- <td><a href="index.php?com=photo&act=edit_chiase&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><img src="<?=_upload_hinhanh.$v['photo']?>" width="50" border="0" /></a></td>-->
                    <td><a href="index.php?com=photo&act=edit_chiase&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten']?></td>
                    ...
                    <!--<td style="width:5%;"><a href="index.php?com=photo&act=delete_chiase&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>-->
                  </tr>
                  <?php	
						}
					}
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                 <!-- <a href="index.php?com=photo&act=add_chiase<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm hình ảnh</a>-->
                  <a href="index.php?com=photo&act=man_chiase" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
                </div>
