      ...
      <!-- Inline Form Start -->      	      
        <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="inner">
            ...
            <!-- Title Bar Start -->
            <div class="title-bar">
              <h4><a href="index.php?com=photo&act=add_video<?=$chuoi_noi_curpage?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm video</a></h4>
            </div>
            <!-- Title Bar End -->                        
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">       
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=photo&act=edit_video&id=<?=$v['id']?><?=$chuoi_noi_curpage?>" style="text-decoration:none;"><?=$v['ten_vi']?></td>
