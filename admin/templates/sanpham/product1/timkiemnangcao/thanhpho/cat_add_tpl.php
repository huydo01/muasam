...
<form name="frm" method="post" action="index.php?com=product1&act=save_thanhpho<?=((@$_REQUEST['curPage']!="")?("&curPage=".@$_REQUEST['curPage']):"")?>" enctype="multipart/form-data" class="nhaplieu">	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product1&act=man_thanhpho'" class="btn" />
</form>