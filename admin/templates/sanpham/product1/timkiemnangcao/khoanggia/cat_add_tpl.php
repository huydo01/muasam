		...
		<!-- Inline Form Start -->
          <div class="boxed no-padding col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="inner">
              ...
              <form method="post" name="frm" action="index.php?com=product1&act=save_khoanggia<?=$chuoi_noi_curpage?>" enctype="multipart/form-data" class="basic-form inline-form">                
                <div class="col-md-2"><label>Giá từ </label></div>
                <div class="col-md-10"><input type="text" name="ten" id="ten" value="<?=$item['ten']?>" placeholder="Giá từ" /></div> 
                <div class="col-md-2"><label>Giá đến </label></div>
                <div class="col-md-10"><input type="text" name="ten2" id="ten2" value="<?=$item['ten2']?>" placeholder="Giá đến" /></div>        
                ...
                <div class="col-md-10 col-md-offset-2">                  
                  ...
                  <button type="button" onclick="javascript:window.location='index.php?com=product1&act=man_khoanggia<?=$chuoi_noi_curpage?>'" class="btn btn-info"><i class="fa fa-share"></i> Thoát</button>
                </div>
