                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td><a href="index.php?com=product&act=edit_cat&id=<?=$v['id']?><?=$chuoi_noi_curpage1?>"><?=$v['ten_vi']?></a></td>
					...
					<!--<td style="width:5%;"><a href="index.php?com=product&act=man_cat&noibat=<?=$v['id']?><?=$chuoi_noi_curpage1?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>-->
                 
					<!--  <td style="width:5%;"><a href="index.php?com=product&act=man_cat&hot=<?=$v['id']?><?=$chuoi_noi_curpage1?>"><img src="<?=($v['hot']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>-->
				
                    <td style="width:5%;"><a href="index.php?com=product&act=man_cat&hienthi=<?=$v['id']?><?=$chuoi_noi_curpage1?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
