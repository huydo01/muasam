              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">           
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <!--<td style="width:5%;"><a href="index.php?com=product&act=man_cat1&noibat=<?=$v['id']?><?=$chuoi_noi_curpage2?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> -->                   
                    <td style="width:5%;"><a href="index.php?com=product&act=man_cat1&hienthi=<?=$v['id']?><?=$chuoi_noi_curpage2?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
