          ...
          <div class="inner">
            ...
            <div class="title-bar">
              <div class="col-md-8" style="padding-left:0px; padding-top:7px; padding-bottom:7px;">                 
              	<h4><a href="index.php?com=product&act=add_cat2<?=$chuoi_noi_curpage3?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm danh mục cấp 3</a></h4>      
              </div>
              <div class="col-md-4 paging_0px">  
              	<form action="index.php?com=product&act=man_cat2<?=$chuoi_noi_curpage3?>" method="post" class="inline-form">
              ...
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">  
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="index.php?com=product&act=edit_cat2&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>" style="text-decoration:none;"><?=$v['ten_vi']?></a></td>
                    <!--<td style="width:5%;"><a href="index.php?com=product&act=man_cat2&noibat=<?=$v['id']?><?=$chuoi_noi_curpage3?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> -->                   
                    <td style="width:5%;"><a href="index.php?com=product&act=man_cat2&hienthi=<?=$v['id']?><?=$chuoi_noi_curpage3?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=product&act=edit_cat2&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>"><img src="media/images/edit.png" border="0" title="Sửa" /></a></td>
                    <td style="width:5%;"><a href="index.php?com=product&act=delete_cat2&id=<?=$v['id']?><?=$chuoi_noi_curpage3?>" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="media/images/delete.png" border="0" title="Xóa" /></a></td>
                  </tr>
                  <?php	
						}
					}
			...
			<div class="col-md-12 margin_bottom_10px">
                <div class="col-md-4 paging_0px">                  
                  <a href="index.php?com=product&act=add_cat2<?=$chuoi_noi_curpage3?>" class="btn btn-success"><i class="fa fa-check"></i> Thêm danh mục cấp 3</a>
                  <a href="index.php?com=product&act=man_cat2" class="btn btn-info"><i class="fa fa-share"></i> Thoát</a> 
                </div>
