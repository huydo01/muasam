            ...
            <div class="table-holder">                            
              <table class="stripe-rows" cellspacing="0" cellpadding="0" width="100%" border="1">   
                <thead>
					...
					<th style="width:20%;"> Cấp 1 <!--/ Cấp 2 / Cấp 3--></th>
					<th style="width:76px;">Ảnh đại diện</th>
					<th>Tên</th>
					<th style="width:5%;">Hình<br />ảnh</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width:5%;"><a href="index.php?com=product&act=man&noibat=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['noibat']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> 
                   <td style="width:5%;"><a href="index.php?com=product&act=man&hot=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['hot']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> 
					
                    <td style="width:5%;"><a href="index.php?com=product&act=man&spmoi=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['spmoi']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td> 
					
                    <td style="width:5%;"><a href="index.php?com=product&act=man&spbanchay=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['spbanchay']==1)?'media/images/yes-km.gif':'media/images/no-km.gif'?>" border="0" /></a></td>      
                                
                    <td style="width:5%;"><a href="index.php?com=product&act=man&hienthi=<?=$v['id']?><?=$chuoi_noi_curpage?>"><img src="<?=($v['hienthi']==1)?'media/images/active_1.png':'media/images/active_0.png'?>" border="0" /></a></td>
