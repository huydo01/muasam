...
switch($act){	
	...
	case "man":
		gets();
		$template = "sanpham/product1/cats";
		break;
	case "add":		
		$template = "sanpham/product1/cat_add";
		break;
	case "edit":		
		get();
		$template = "sanpham/product1/cat_add";
	...
	case "man_tinhtrang":
		get_tinhtrangs();
		$template = "sanpham/product1/tinhtrang/cats";
		break;
	case "add_tinhtrang":		
		$template = "sanpham/product1/tinhtrang/cat_add";
		break;
	case "edit_tinhtrang":		
		get_tinhtrang();
		$template = "sanpham/product1/tinhtrang/cat_add";
	...
	case "man_ptthanhtoan":
		get_ptthanhtoans();
		$template = "sanpham/product1/phuongthucthanhtoan/cats";
		break;
	case "add_ptthanhtoan":		
		$template = "sanpham/product1/phuongthucthanhtoan/cat_add";
		break;
	...
	case "man_ptgiaonhan":
		get_ptgiaonhans();
		$template = "sanpham/product1/phuongthucgiaonhan/cats";
		break;
	case "add_ptgiaonhan":		
		$template = "sanpham/product1/phuongthucgiaonhan/cat_add";
		break;
	...
	case "man_khoanggia":
		get_khoanggias();
		$template = "sanpham/product1/timkiemnangcao/khoanggia/cats";
		break;
	case "add_khoanggia":		
		$template = "sanpham/product1/timkiemnangcao/khoanggia/cat_add";
		break;
	case "edit_khoanggia":		
		get_khoanggia();
		$template = "sanpham/product1/timkiemnangcao/khoanggia/cat_add";
	...
	case "man_giatu":
		get_giatus();
		$template = "sanpham/product1/timkiemnangcao/giatu/cats";
		break;
	case "add_giatu":		
		$template = "sanpham/product1/timkiemnangcao/giatu/cat_add";
		break;
	case "edit_giatu":		
		get_giatu();
		$template = "sanpham/product1/timkiemnangcao/giatu/cat_add";
	...
	case "man_giaden":
		get_giadens();
		$template = "sanpham/product1/timkiemnangcao/giaden/cats";
		break;
	case "add_giaden":		
		$template = "sanpham/product1/timkiemnangcao/giaden/cat_add";
		break;
	case "edit_giaden":		
		get_giaden();
		$template = "sanpham/product1/timkiemnangcao/giaden/cat_add";
	...
	case "man_huong":
		get_huongs();
		$template = "sanpham/product1/timkiemnangcao/huong/cats";
		break;
	case "add_huong":		
		$template = "sanpham/product1/timkiemnangcao/huong/cat_add";
		break;
	case "edit_huong":		
		get_huong();
		$template = "sanpham/product1/timkiemnangcao/huong/cat_add";
	...
	case "man_thanhpho":
		get_thanhphos();
		$template = "sanpham/product1/timkiemnangcao/thanhpho/cats";
		break;
	case "add_thanhpho":		
		$template = "sanpham/product1/timkiemnangcao/thanhpho/cat_add";
		break;
	case "edit_thanhpho":		
		get_thanhpho();
		$template = "sanpham/product1/timkiemnangcao/thanhpho/cat_add";
	...
	case "man_quanhuyen":
		get_quanhuyens();
		$template = "sanpham/product1/timkiemnangcao/thanhpho/quanhuyen/cats";
		break;
	case "add_quanhuyen":		
		$template = "sanpham/product1/timkiemnangcao/thanhpho/quanhuyen/cat_add";
		break;
	case "edit_quanhuyen":		
		get_quanhuyen();
		$template = "sanpham/product1/timkiemnangcao/thanhpho/quanhuyen/cat_add";
	...
	case "man_duongpho":
		get_duongphos();
		$template = "sanpham/product1/timkiemnangcao/thanhpho/duongpho/cats";
		break;
	case "add_duongpho":		
		$template = "sanpham/product1/timkiemnangcao/thanhpho/duongpho/cat_add";
		break;
	case "edit_duongpho":		
		get_duongpho();
		$template = "sanpham/product1/timkiemnangcao/thanhpho/duongpho/cat_add";
