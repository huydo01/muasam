<?php
	...
	$mcImageManagerConfig['filesystem.path'] = '../../../../upload/tiny/'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../upload/tiny/'; // absolute or relative from this script path, required.
