...
$p = xml_parser_create();	//Tạo bộ phân tích
xml_parse_into_struct($p, $content, $xml);	//Đưa dữ liệu file xml vào mảng $xml
xml_parser_free($p);	//Giải phóng bộ phan tích(Hủy).
?>
